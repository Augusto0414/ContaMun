    ...
    return (
        <View className="bg-white flex-1 px-5">
            ...
            <ScrollView>
                ...
                <View className="mb-3">
                    <View className={`flex-row items-center border px-4 py-3 rounded-2xl ${errors.name ? 'border-red-500' : 'border-gray-300'}`}>
                ...
                <View className="mb-3">
                    <View className={`flex-row items-center border px-4 py-3 rounded-2xl ${errors.email ? 'border-red-500' : 'border-gray-300'}`}>
                ...
                <View className="mb-3">
                    <View className={`flex-row items-center border px-4 py-3 rounded-2xl ${errors.password ? 'border-red-500' : 'border-gray-300'}`}>
                ...
                <View className="mb-3">
                    <View className={`flex-row items-center border px-4 py-3 rounded-2xl ${errors.verifyPassword ? 'border-red-500' : 'border-gray-300'}`}>
