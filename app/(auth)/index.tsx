...
export default function AuthIndex() {
    ...
    return (
        <View className="bg-white flex-1 px-5">
            ...
            <View className="mb-3">
                <View className={`flex-row items-center border ${errors.email ? 'border-red-500' : 'border-gray-300'} px-4 py-3 rounded-2xl`}>
            ...
            <View className="mb-3">
                <View className={`flex-row items-center border ${errors.password ? 'border-red-500' : 'border-gray-300'} px-4 py-3 rounded-2xl`}>
